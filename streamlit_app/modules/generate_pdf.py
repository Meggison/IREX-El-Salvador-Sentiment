...
def generate_pdf(fig1=None, fig2=None, fig3=None, fig4=None, fig5=None, fig6=None, fig7=None):
    try:
        ...
        c.drawString(100, 800, "Reporte de Análisis de Sentimiento")
        ...
        if fig6 is not None:
            ...
            c.drawImage(image6, 100, 200, width=400, height=200)
        ...
        if fig7 is not None:
            ...
            c.drawImage(image7, 100, 600, width=400, height=200)
...
def construct_pdf():
    fig1 = ("Sentimiento vs. Tiempo transcurrido", st.session_state["sentiment_over_date"])
    fig2 = ("Distribución Sentimiento", st.session_state["display_target_count"])
    fig3 = ("Bigramas más frecuentes", st.session_state["most_common_trigrams"])
    fig4 = ("Nube de Palabras - Términos más comunes", st.session_state["display_word_cloud"])
    fig5 = ("Relación entre Número de Likes y Etiquetas de Sentimiento", st.session_state["crear_grafico_dispersion"])
    fig6 = ("Distribución del Tiempo de Creación de Cuenta por Sentimiento de Comentario", st.session_state["stacked_bar_fig"])
    fig7 = ("Ubicación usuarios", st.session_state["locations_graphic"])
